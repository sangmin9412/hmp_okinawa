...
export const InfoContainerKO = async () => {
      ...
      <div className='container'>
        ...
        <div className='lg:pt-[6.4rem] pt-[4rem] lg:pb-[8.0rem] pb-[5.6rem]'>
          ...
          <InfoItem className='pt-0'>
            ...
            <InfoItem.SubTitle>
              <span
                className='font-[500] lg:text-[1.8rem] text-[1.6rem]'
            ...
            <p className='mt-[1.6rem] lg:text-[1.8rem] lg:leading-[2rem] text-[1.5rem] leading-[2.4rem] text-primary'>
              쿠폰 발급 후,
              <br className='mo-only' /> 반드시 ‘현대 EV 예약하기’ 버튼 클릭을 통해
              <br className='mo-only' /> OTS 렌터카 홈페이지에서 차량 예약을 진행해 주세요.
            </p>

            {/* S: Item 01 - Car Area */}
            <div className='mt-[2.4rem] mb-[2.4rem] lg:p-[4.0rem] px-[2rem] py-[4rem] bg-[#E5F1FB] rounded-lg'>
              {/* PC 텍스트 */}
              <div className='lg:block hidden'>
                <div className='mb-[3.2rem] flex flex-col justify-center items-center lg:gap-[1.6rem] font-[500]'>
                  <p className='text-[2.4rem] leading-[1.5]'>{t("item_01.carRent")}</p>
                  <p className='text-[3.0rem] leading-[1] text-[#0793EA] text-center'>{t("item_01.carRentPrice")}</p>
                </div>
              </div>

              {/* MO 텍스트 */}
              <div className='lg:hidden block'>
                <div className='mb-[2.4rem] flex flex-col justify-center items-center gap-[0.8rem] font-[500]'>
                  <p className='text-[1.4rem] leading-[1.6]'>{t("item_01.carRent")}</p>
                  <p className='text-[2.4rem] leading-[1.5] text-[#0793EA] text-center'>
                    오키나와 여행이 쉬워지는
                    <br />
                    15만원 상당의 혜택!
                  </p>
              ...
              <div className='lg:mb-[2.4rem] mb-[3.2rem] flex items-center justify-center flex-col lg:flex-row lg:gap-[2.6rem] gap-[1.2rem]'>
                <div className='flex flex-col items-center justify-center lg:gap-[.8rem] gap-[.4rem]'>
                  <i>
                    <Image
                      src={getImagePath("/images/ic_card_01.svg")}
                      width={56}
                      height={34}
                      alt='최고 보장 등급 자동차 보험'
                      className='lg:w-auto w-[5.6rem] lg:h-[3.4rem] h-auto'
                    />
                  </i>
                  <p className='lg:text-[2rem] text-[1.8rem] lg:leading-[3.2rem] leading-[3rem] font-[500]'>
                    최고 보장 등급 자동차 보험
                  </p>
                </div>
                <i>
                  <svg
                    ...
                    className='lg:w-[2.4rem] w-[1.6rem] lg:h-[2.4rem] h-[1.6rem]'
                  >
                    <path d='M12.4194 2V22M22.5 11.9194L2.5 11.9194' stroke='#CCCCCC' strokeWidth='4' />
                  </svg>
                </i>
                <div className='flex flex-col items-center justify-center lg:gap-[.8rem] gap-[.4rem]'>
                  <i>
                    <Image
                      src={getImagePath("/images/ic_card_02.svg")}
                      width={56}
                      height={34}
                      alt='무제한 고속도로 통행 카드(ETC)'
                      className='lg:w-auto w-[5.6rem] lg:h-[3.4rem] h-auto'
                    />
                  </i>
                  <p className='lg:text-[2rem] text-[1.8rem] lg:leading-[3.2rem] leading-[3rem] font-[500]'>
                ...
                <div className='flex flex-col items-center justify-center lg:gap-[.8rem] gap-[.4rem]'>
                  <i>
                    <Image
                      src={getImagePath("/images/ic_card_03.svg")}
                      width={56}
                      height={34}
                      alt='무제한 EV 충전 카드'
                      className='lg:w-auto w-[5.6rem] lg:h-[3.4rem] h-auto'
              ...
              <div className='lg:mb-[2.4rem] mb-[3.2rem] flex lg:flex-row flex-col flex-wrap justify-center items-center lg:text-[1.6rem] text-[1.4rem] leading-[1.6]'>
                <p className='lg:pr-[1.2rem] font-[500]'>{t("item_01.carRentPeriod")}</p>
                <p className='font-[400] lg:before:content-[""] lg:before:mr-[1.2rem] lg:before:inline-block lg:before:w-[0.1rem] lg:before:h-[1.2rem] lg:before:bg-[#333] lg:text-left text-center'>
                  2025. 4. 18 ~ 2025. 12. 31
                </p>
              </div>
          ...
          {/* S: Item 04 */}
          <InfoItem className='lg:pb-[3.0rem]'>
            ...
            <div className='flex lg:flex-row flex-col justify-center lg:gap-[3.2rem] gap-[2.4rem]'>
              <div className='relative lg:flex-[35.2rem] flex flex-col lg:overflow-visible overflow-hidden'>
                ...
                >
                  <DotList
                    items={[
                      <p key='p1' dangerouslySetInnerHTML={{ __html: t.raw("item_04.step_01.list_01") }} />,
                      <p key='p2' dangerouslySetInnerHTML={{ __html: t.raw("item_04.step_01.list_02") }} />,
                      <p key='p3' dangerouslySetInnerHTML={{ __html: t.raw("item_04.step_01.list_03") }} />,
                      <p key='p4' dangerouslySetInnerHTML={{ __html: t.raw("item_04.step_01.list_04") }} />
                    ]}
                  />
                </div>
              </div>
              ...
              <div className='relative lg:flex-[35.2rem] flex flex-col lg:overflow-visible overflow-hidden'>
                ...
                >
                  <DotList
                    items={[
                      <p key='p1' dangerouslySetInnerHTML={{ __html: t.raw("item_04.step_02.list_01") }} />,
                      <p key='p2' dangerouslySetInnerHTML={{ __html: t.raw("item_04.step_02.list_02") }} />
                    ]}
                  />
                </div>
              </div>
              ...
              <div className='relative lg:flex-[35.2rem] flex flex-col lg:overflow-visible overflow-hidden'>
                ...
                >
                  <DotList
                    items={[
                      <p key='p1' dangerouslySetInnerHTML={{ __html: t.raw("item_04.step_03.list_01") }} />,
                      <p key='p2' dangerouslySetInnerHTML={{ __html: t.raw("item_04.step_03.list_02") }} />
                    ]}
                  />
                </div>
              </div>
            ...
            <div className='px-[3.2rem] pt-[3.2rem] pb-[4rem] bg-[#FAFAFA] rounded-[0.8rem]'>
              <div className='lg:mb-[1.6rem] mb-[2.4rem] flex lg:flex-row flex-col gap-[1.6rem]'>
                ...
                <div className='lg:block flex flex-col gap-[1.6rem]'>
                  <p
                    className='lg:text-[1.8rem] text-[1.5rem] lg:leading-[1.6] leading-[1.5] font-[500]'
                    dangerouslySetInnerHTML={{
                      __html: t.raw("item_05.notice.head")
                    }}
                  />
                  <div className='flex lg:flex-row flex-col lg:gap-[1.2rem] gap-[0.4rem] lg:text-[1.6rem] text-[1.4rem] lg:leading-[1.6] leading-[1.5] text-[#666]'>
                    ...
                    />
                    <p
                      className='flex gap-[1.2rem] lg:items-center font-[400] before:inline-flex before:content-[""] lg:before:mt-0 before:mt-[.4rem] before:w-[0.1rem] before:h-[1.2rem] before:bg-[#666]'
                      dangerouslySetInnerHTML={{
                  ...
                  <div className='flex lg:flex-row flex-col lg:gap-[1.2rem] gap-[0.4rem] lg:text-[1.6rem] text-[1.4rem] lg:leading-[1.6] leading-[1.5] text-[#666]'>
                    ...
                    <p className='flex gap-[1.2rem] lg:items-center font-[400] before:inline-flex before:content-[""] lg:before:mt-0 before:mt-[.4rem] before:w-[0.1rem] before:h-[1.2rem] before:bg-[#666]'>
              ...
              <DotList
                items={[
                  <p
                    key='p1'
                    dangerouslySetInnerHTML={{
                      __html: t.raw("item_05.notice.list_01")
                    }}
                  />,
