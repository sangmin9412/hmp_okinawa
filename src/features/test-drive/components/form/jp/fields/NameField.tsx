...
import { handleTextOnlyInput, handleTextOnlyPaste } from "@/lib/utils";
...
export default function NameFieldJP({ form }: NameFieldProps) {
  const t = useTranslations("form");

  return (
    <>
      <FormRow label={t("label.name")} required names={["lastName", "firstName"]}>
      ...
      <FormRow label={t("label.name_passport")} required names={["lastNameHurigana", "firstNameHurigana"]}>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-[1.6rem]'>
          <FormFieldInput
            form={form}
